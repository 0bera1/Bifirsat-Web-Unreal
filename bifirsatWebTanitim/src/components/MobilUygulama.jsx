...
function MobilUygulama() {
  ...
  const handleNext = () => {
    setCurrentIndex((prevIndex) => prevIndex + 1.138);
  };
  ...
  const imagesToShow = isMobile ? images2 : images;

  return (
    <div id="mobiluygulama" className="max-w-7xl mx-auto py-8 px-4">
      <h2 className="text-3xl font-bold text-center text-[#ffbf00] lg:text-black mb-2">
        Mobil Uygulamamız {"(Çok Yakında !)"}
      </h2>
      <h2 className="text-xl font-bold text-center text-[#ffbf00] lg:text-black mb-16">
      ...
      <div className="relative">
        ...
        {currentIndex < imagesToShow.length - 1 && (
          <button
            onClick={handleNext}
      ...
      <div className="flex justify-center items-center mt-14  space-x-2 lg:space-x-10">
        <a href="https://apps.apple.com/" target="_blank" rel="noopener noreferrer">
          <div className="border border-[#ffbf00] lg:border-black hover:border-black lg:hover:border-[#ffbf00] flex flex-row p-3 lg:p-6 rounded-xl transition duration-700 ease-in-out hover:bg-[#ffbf00] lg:hover:bg-black group">
            <FaAppStoreIos className="lg:text-5xl text-8xl text-[#ffbf00] lg:text-[black] group-hover:text-black lg:group-hover:text-[#ffbf00] items-center justify-center" />
            <h6 className="text-[#ffbf00] lg:text-black text-sm lg:text-lg font-bold items-center justify-center mt-4 ml-4 lg:mt-2 lg:ml-2 transition duration-700 ease-in-out group-hover:text-black lg:group-hover:text-[#ffbf00]">
        ...
        <div className="border border-[#ffbf00] lg:border-black hover:border-black lg:hover:border-[#ffbf00] flex flex-row p-3 lg:p-6 rounded-xl transition duration-700 ease-in-out hover:bg-[#ffbf00] lg:hover:bg-black group">
        <FaGooglePlay className="lg:text-5xl text-8xl text-[#ffbf00] lg:text-[black] group-hover:text-black lg:group-hover:text-[#ffbf00] items-center justify-center" />
        <h6 className="text-[#ffbf00] lg:text-black text-sm lg:text-lg font-bold items-center justify-center mt-4 ml-4 lg:mt-2 lg:ml-2 transition duration-700 ease-in-out group-hover:text-black lg:group-hover:text-[#ffbf00]">
